...
func TestPrepareKeys(t *testing.T) {
	...
	// 生成私钥pem文件
	_, err = x509.WritePrivateKeytoPemFile("/Users/wangning/GolandProjects/zcutils-go/testdata/sm2_pri_key.pem", sm2Priv, nil)
	if err != nil {
		t.Fatal(err)
	}
	// 生成公钥pem文件
	_, err = x509.WritePublicKeytoPemFile("/Users/wangning/GolandProjects/zcutils-go/testdata/sm2_pub_key.pem", sm2Pub)
	if err != nil {
		t.Fatal(err)
	}
	// 从pem文件读取私钥
	...
	// 生成私钥pem文件
	_, err = x509.WritePrivateKeytoPemFile("/Users/wangning/GolandProjects/zcutils-go/testdata/ec_pri_key.pem", ecPri, nil)
	if err != nil {
		t.Fatal(err)
	}
	// 生成公钥pem文件
	_, err = x509.WritePublicKeytoPemFile("/Users/wangning/GolandProjects/zcutils-go/testdata/ec_pub_key.pem", ecPub)
	if err != nil {
		t.Fatal(err)
	}
	...
	// 生成私钥pem文件
	_, err = x509.WritePrivateKeytoPemFile("/Users/wangning/GolandProjects/zcutils-go/testdata/ed_pri_key.pem", edPri, nil)
	if err != nil {
		t.Fatal(err)
	}
	// 生成公钥pem文件
	_, err = x509.WritePublicKeytoPemFile("/Users/wangning/GolandProjects/zcutils-go/testdata/ed_pub_key.pem", edPub)
	if err != nil {
		t.Fatal(err)
	}
...
func TestBuildTokenWithSm2Sm3(t *testing.T) {
	// 从pem文件读取私钥pem
	privKeyPem, err := ioutil.ReadFile("/Users/wangning/GolandProjects/zcutils-go/testdata/sm2_pri_key.pem")
	if err != nil {
		t.Fatal(err)
	}
	// 从pem文件读取公钥pem
	pubKeyPem, err := ioutil.ReadFile("/Users/wangning/GolandProjects/zcutils-go/testdata/sm2_pub_key.pem")
	if err != nil {
		t.Fatal(err)
	}
...
//	// 从pem文件读取私钥pem
//	privKeyPem, err := ioutil.ReadFile("/Users/wangning/GolandProjects/zcutils-go/testdata/ec_pri_key.pem")
//	if err != nil {
//		t.Fatal(err)
//	}
//	// 从pem文件读取公钥pem
//	pubKeyPem, err := ioutil.ReadFile("/Users/wangning/GolandProjects/zcutils-go/testdata/ec_pub_key.pem")
//	if err != nil {
//		t.Fatal(err)
//	}
//
...
//	// 从pem文件读取私钥pem
//	privKeyPem, err := ioutil.ReadFile("/Users/wangning/GolandProjects/zcutils-go/testdata/ed_pri_key.pem")
//	if err != nil {
//		t.Fatal(err)
//	}
//	// 从pem文件读取公钥pem
//	pubKeyPem, err := ioutil.ReadFile("/Users/wangning/GolandProjects/zcutils-go/testdata/ed_pub_key.pem")
//	if err != nil {
//		t.Fatal(err)
//	}
//
